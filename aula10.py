...
train = pd.read_csv('/home/bruno/w2v/csumb/r8-train-all-terms.txt', header=None, sep='\t')
test = pd.read_csv('/home/bruno/w2v/csumb/r8-test-all-terms.txt', header=None, sep='\t')
